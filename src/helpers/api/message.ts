...
export const Bot_sendMsg = async (text:string,userId:string,botIndex:number) => {
...
export const Bot_sendMsgBadChoice = async (userId:string, botIndex:number) => {
  const url = genUrl(sendMsg,botIndex)
...
export const Bot_sendKeyboard = async (text:string,userId:string,botIndex:number,options:string[]) => {
  const url = genUrl(sendMsg,botIndex)
...
export const Bot_sendPhoto = async (photo:string,userId:string,botIndex:number) => {
...
export const Bot_sendInlineKeyboard = async (text:string,userId:string,botIndex:number,options:string[]) => {
  const url = genUrl(sendMsg,botIndex)
